...
public class DragScaleView extends View implements View.OnTouchListener {
    ...
    /**
     *
     * getWidth view的宽度,getHeight view的高度
     *
     */
    @Override
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, 0, getWidth() - 0, getHeight()
                - 0, paint);
//        canvas.drawText("1",offset, offset, getWidth() - offset, getHeight()
//                - offset, paint);
