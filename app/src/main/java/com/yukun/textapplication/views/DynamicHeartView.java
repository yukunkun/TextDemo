...
public class DynamicHeartView extends View {
    ...
    // 起始点
    private static final int[] START_POINT = new int[] {200, 100};
    // 爱心下端点
    private static final int[] BOTTOM_POINT = new int[] {200, 200};
    // 左侧控制点
    private static final int[] LEFT_CONTROL_POINT = new int[] {300,70};
    // 右侧控制点
    private static final int[] RIGHT_CONTROL_POINT = new int[] {100,70};
